...
##############################################################################
{
    ...
    'version': '10.0.1.1.14',
    'author': "Comunitea",
    'maintainer': 'Fenix Engineering Solutions',
    'website': 'http://www.comunitea.com',
    'license': 'AGPL-3',
    'category': '',
    'summary': 'Modulo gestión de colegios',
    'depends': [
        'base', 'project', 'account', 'account_accountant', 'scat_res_partner'
    ],
    ...
    'data': [
        ...
        'data/scat_student_holidays.xml',
        'data/scat_school_management_data.xml',
        'data/scat_school_management_inv_cron.xml',
        ...
        'views/scat_school_ise_integration_view.xml',
